...
namespace BuildABear.Infrastructure.Migrations
{
    ...
    [Migration("20240424083434_ModifiedUsersCart")]
    partial class ModifiedUsersCart
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuildABear.Core.Entities.User", b =>
                {
                    ...
                    b.Property<Guid>("MainCartId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("MainCartId1")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BuildABear.Core.Entities.User", b =>
                {
                    b.HasOne("BuildABear.Core.Entities.Cart", "MainCart")
                        .WithMany()
                        .HasForeignKey("MainCartId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
