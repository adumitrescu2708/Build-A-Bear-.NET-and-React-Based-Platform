...
using BuildABear.Infrastructure.Configurations;
using BuildABear.Infrastructure.Database;
using BuildABear.Infrastructure.Workers;
using BuildABear.Infrastructure.Converters;
using BuildABear.Infrastructure.Repositories.Implementation;
using Autofac.Core;
using BuildABear.Core.Enums;

namespace BuildABear.Infrastructure.Extensions;
...
public static class WebApplicationBuilderExtensions
{
    ...
    public static WebApplicationBuilder AddServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services
            ...
            .AddTransient<ITeddyItemService, TeddyItemService>()
    ...
    public static WebApplicationBuilder AddWorkers(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddHostedService<TeddyTemplateInitializerWorker>();
        return builder;
    }
}
