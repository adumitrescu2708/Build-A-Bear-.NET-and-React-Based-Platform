...
public interface ITeddyTemplateService
{
    ...
    public Task<ServiceResponse> AddTeddyTemplate(TeddyTemplateAddDTO template, UserDTO? requestingUser = default, CancellationToken? cancellationToken = default);
    ...
    public Task<ServiceResponse<PagedResponse<Guid>>> GetAll(PaginationQueryParams pagination, CancellationToken cancellationToken = default);
}
