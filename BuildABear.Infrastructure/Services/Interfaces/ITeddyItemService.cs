...
{
    public Task<ServiceResponse<TeddyItemViewDTO>> AddItem(TeddyItemAddDTO item, UserDTO? requestingUser, CancellationToken cancellationToken = default);
    ...
    public Task<ServiceResponse> Update(TeddyItemUpdateDTO template, UserDTO? requestingUser, CancellationToken cancellationToken = default);
}
