...
//                                         autoComplete="none"
//                                     />
//                                     <FormHelperText hidden={isUndefined(state.errors.contractStartDate)}>
...
//                             <Grid container item direction="column" xs={6} md={6}>
//                                 <FormControl fullWidth error={!isUndefined(state.errors.contractEndDate)}>
//                                     <FormLabel>
...
//                                         autoComplete="none"
//                                     />
//                                     <FormHelperText hidden={isUndefined(state.errors.contractEndDate)}>
...
//                             <Grid container item direction="column" xs={6} md={6}>
//                                 <FormControl fullWidth error={!isUndefined(state.errors.paymentMethod)}>
//                                     <FormLabel>
...
//                                         onChange={actions.selectPaymentMethod}
//                                         displayEmpty
//                                     >
...
//                                         </MenuItem>
//                                     </Select>
//                                     <FormHelperText hidden={isUndefined(state.errors.paymentMethod)}>
...
//                             <Grid container item direction="column" xs={6} md={6}>
//                                 <FormControl fullWidth error={!isUndefined(state.errors.contractRenewalTerms)}>
//                                     <FormLabel>
...
//                                         onChange={actions.selectContractRenewalTerms}
//                                         displayEmpty
//                                     >
//                                         <MenuItem value="" disabled>
//                                             <span className="text-gray">
...
//                 <DialogTitle><FormattedMessage id="globals.confirmation" /></DialogTitle>
//                 <DialogContent>
//                     <DialogContentText>
//                         <FormattedMessage id="globals.confirmEditVendor" />
//                     </DialogContentText>
//                 </DialogContent>
//                 <DialogActions>
...
//                         <FormattedMessage id="globals.confirm" />
//                     </Button>
//                 </DialogActions>
//             </Dialog>
//         </>
