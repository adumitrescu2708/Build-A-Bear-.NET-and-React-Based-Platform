...
export const RegisterVendorForm = (props: { onSubmit?: () => void }) => {
    ...
    return (
        <form onSubmit={handleClickOpen}> {/* Wrap your form into a form tag and use the handle submit callback to validate the form and call the data submission. */}
            <Stack spacing={4} style={{ width: "100%" }}>
                <div>
                    <Grid container item direction="row" xs={12} columnSpacing={4}>
                        <Grid container item direction="column" xs={6} md={6}>
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    <DialogContentText>
                        {formatMessage({ id: "globals.confirmVendorAdd" })}
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
